...
* [`src/cljs/cockpit/`](src/cljs/cockpit/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/cockpit/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/cockpit/`](test/cljs/cockpit/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `cockpit` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cockpit/config.cljs) defaults to `true` in
